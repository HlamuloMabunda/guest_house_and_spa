...
<body>
    ...
    <!-- Navbar End -->
      <!--Registration form start-->
                    <form action="Adminpasswordresetcode.php" method="POST" style="margin-left:400px;margin-top:20px;">
              <div class="form-container">        
                    <div class="col-sm-7">
                                <div class="form-group">
                              <h1 style="color:pink; text-align:center;">PASSWORD RESET</h1>    
                            </div>
                            </div>   
                            <div class="col-sm-7">
                            <?php 
            ...
            ?>      
                                <div class="form-group">
                                    <input type="email" class="form-control bg-transparent p-4" placeholder="Your Email" name="email" />
                                     ...
                                     <div class="col-sm-7">
                                <button class="btn btn-primary btn-block" type="submit" name="AdminPasswordresetlink.php" style="height: 47px; border:1px solid pink;color:pink;hover:cursor;">SEND PASSWORD RESET LINK</button>
                            </div>
                        </div>
                    </form>
                </div>
