...
<body>
    ...
    <div class="collapse navbar-collapse justify-content-between px-lg-3 m-auto" id="navbarCollapse">
        <div class="navbar-nav m-auto py-0">
            <a href="roomservice.php" class="nav-item nav-link active">Room Services</a>    
            <a href="spaservice.php" class="nav-item nav-link">Spa Services</a>
        </div>
    </div>
    ...
    <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h3 class="text-white display-3 mb-4">ROOM RESERVATION</h3>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="">Let's book for room accommodation here!...</a></p> 
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid px-0 py-5 my-5">
        <div class="row mx-0 justify-content-center text-center">
            <div class="col-lg-6">
                <h6 class="d-inline-block bg-light text-primary text-uppercase py-1 px-2">GUEST HOUSE & SPA</h6>
                <h1>ROOM AVAILABLE</h1>
            </div>
        </div>
        <div class="owl-carousel service-carousel">
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/pexels-erik-mclean-9582661.jpg" alt="">
                <div class="service-text text-center">
                    <h4 class="text-white font-weight-medium px-3">DOUBLE BED ROOM</h4>
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit ipsum</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="">GET ROOM</a>
                    </div>
                </div>
            </div>
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/pexels-pixabay-271672.jpg" alt="">
                <div class="service-text text-center">
                    <h4 class="text-white font-weight-medium px-3">SUITE</h4>
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit ipsum</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="">GET ROOM</a>
                    </div>
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/pexels-pixabay-271624.jpg" alt="">
                <div class="service-text text-center">
                    <h4 class="text-white font-weight-medium px-3">SINGLE BED ROOM</h4>
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit ipsum</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="">GET ROOM</a>
                    </div>
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/pexels-pixabay-271624.jpg" alt="">
                <div class="service-text text-center">
                    <h4 class="text-white font-weight-medium px-3">SPECIAL BED ROOM</h4>
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit ipsum</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="">GET ROOM</a>
                    </div>
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/pexels-pixabay-271639.jpg" alt="">
                <div class="service-text text-center">
                    <h4 class="text-white font-weight-medium px-3">BACHELOR BED ROOM</h4>
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit ipsum</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="">GET ROOM</a>
                    </div>
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="img/pexels-erik-mclean-9582661.jpg" alt="">
                <div class="service-text text-center">
                    <h4 class="text-white font-weight-medium px-3">FAMILY BED ROOM</h4>
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit ipsum</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="">GET  ROOM</a>
                    </div>
        ...
        <div class="row justify-content-center bg-appointment mx-0">
            <div class="col-lg-6 py-5">
                <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.7);">
                    <h1 class="text-white text-center mb-4">BOOK A ROOM</h1>
                    <form>
                        <div class="form-row">
                            <div class="col-sm-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                    <p class="m-0 text-white">&copy; <a href="#">2023.Guest House and Spa</a>. All Rights Reserved.</p>
                </div>
