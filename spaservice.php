...
<body>
    ...
    <div class="jumbotron jumbotron-fluid bg-jumbotron" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h3 class="text-white display-3 mb-4">SPA</h3>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="">Let's get appointments for spa treatment here!...</a></p> 
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid px-0 py-5 my-5">
        <div class="row mx-0 justify-content-center text-center">
            <div class="col-lg-6">
                <h6 class="d-inline-block bg-light text-primary text-uppercase py-1 px-2">GH&S</h6>
                <h1>AVAILABLE SPA SERVICES</h1>
            </div>
        </div>
        <div class="owl-carousel service-carousel">
            ...
            <div class="service-item position-relative">
                ...
                <div class="service-text text-center">
                    ...
                    <p class="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo sit ipsum</p>
                    <div class="w-100 bg-white text-center p-4" >
                        <a class="btn btn-primary" href="">MAKE APPOINTMENT</a>
                    </div>
                </div>
            </div>
            <div class="service-item position-relative">
