...
<head>
    <meta charset="utf-8">
    <title>GUESTHOUSEANDSPAPROJECT</title>
...
<!-- Topbar Start-->
    ...
    <a href="index.html" class="position-absolute" style="height:25px; width:30px; top: 50%; right: 0; transform: translateY(-50%); color:pink;border:1px solid pink;border-radius:3%;"><i class="fa fa-arrow-left"></i></button></a>
</nav>
    <!-- Navbar End -->    
      <!--Registration form start-->
                    <form action="code.php" method="POST" style="margin-left:400px;margin-top:20px;width:50%; height:0 auto; border:1px solid pink;">
              <div class="form-container">         
                    <div class="col-sm-12">
                                <div class="form-group">
                              <h1 style="color:pink; text-align:center;">SIGN-UP AS USER</h1>    
                            </div>
                            </div>
            ...
            ?>
                    ...
                    <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control bg-transparent p-4" placeholder="Your Fullname"  name="fullname"/>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="number" class="form-control bg-transparent p-4" placeholder="Your Contact Number" name="contactnumber" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control bg-transparent p-4" placeholder="Your Address" name="address" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="date" class="form-control bg-transparent p-4"  name="dateofbirth" />
                                </div>
                            </div>
                        </div>
                            <div class="col-sm-12 ">
                    ...
                    <label for="female">FEMALE</label>
                           ...
                           <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="password" class="form-control bg-transparent p-4" placeholder="Repeat your password" name="password"/>
                          </div>
                            </div>
                        </div>
                         <div class="col-sm-12">
                                <button class="btn btn-primary btn-block" type="submit" name="usersubmit" style="height: 47px; border:1px solid pink;color:pink;hover:cursor;">SIGN-UP</button>
                                <button class="btn btn-primary btn-block" type="reset"  name="reset" style="height: 47px; border:1px solid pink;color:pink;hover:cursor;">CLEAR</button>
                            </div>
                        </div>
                        <br>
                        <div class="col-sm-12">
                            <hr style="border: 1px solid pink;"></hr>
                                Already have account?<a href="Sign-in.php">Sign-in now</a>
                                <a href="Admin_sign-up.php" class="btn btn-primary" role="button" style="margin-left:32%;">Admin Sign-up</a>
                                <hr style="border: 1px solid pink;"></hr>
                                Didn't receive verification code?<a  href="adminresendvercode.php ">Resend</a>
                            </div>
                        </div>
