...
<body>
    ...
    <div class="collapse navbar-collapse justify-content-between px-lg-3 m-auto" id="navbarCollapse">
        <div class="navbar-nav m-auto py-0">
            <a href="roomservice.php" class="nav-item nav-link">Room Services</a>    
            <a href="spaservice.php" class="nav-item nav-link active">Spa Services</a>
        </div>
    </div>
    ...
    <!-- Navbar End -->
      <!--Registration form start-->
                    <form action="Admincode.php" method="POST" style="margin-left:400px;margin-top:20px;width:50%; height:0 auto; border:1px solid pink;">
              <div class="form-container">         
                    <div class="col-sm-12">
                                <div class="form-group">
                              <h1 style="color:pink; text-align:center;">SIGN-UP AS ADMIN</h1>    
                            </div>
                            </div>        
                            <?php 
            ...
            ?>
                    ...
                    <label for="female">FEMALE</label>
                        ...
                        <div class="col-sm-12">
                                <button class="btn btn-primary btn-block" type="submit" name="adminsubmit" style="height: 47px; border:1px solid pink;color:pink;hover:cursor;">SIGN-UP</button>
                        ...
                        <div class="col-sm-12">
                            <hr style="border: 1px solid pink;"></hr>
                                Already have account?<a href="Adminsignin.php">Sign-in now</a>
