...
<body>
    ...
    <!-- Navbar End -->
      <!--Registration form start-->
                    <form action="Adminsignincode.php" method="POST" style="margin-left:400px;margin-top:20px;">
              <div class="form-container">        
                    <div class="col-sm-7">
                                <div class="form-group">
                              <h1 style="color:pink; text-align:center;">SIGN-IN AS ADMIN</h1>    
                            </div>
                            </div>   
                            <div class="col-sm-7">
                            <?php 
            ...
            ?>      
                         ...
                         <div class="col-sm-7">
                                <button class="btn btn-primary btn-block" type="submit" name="adminsignin" style="height: 47px; border:1px solid pink;color:pink;hover:cursor;">SIGN-IN</button>
