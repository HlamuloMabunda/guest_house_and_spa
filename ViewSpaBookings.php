        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    <a href="ViewRoomBookings.php" class="nav-item nav-link">VIEW ROOM BOOKINGS</a>
                    <a href="ViewSpaBookings.php" class="nav-item nav-link active">VIEW SPA BOOKINGS</a>                    
                    <a href="ViewAllBookings.php" class="nav-item nav-link"> VIEW ALL BOOKINGS</a>
                    <a href="ViewBookingHistory.php" class="nav-item nav-link"> VIEW BOOKING HISTORY</a>
                    <a href="AdminHome.php" class="position-absolute" style="height:25px; width:30px; top: 50%; right: 0; transform: translateY(-50%); color:pink;border:1px solid pink;border-radius:3%;"><i class="fa fa-arrow-left"></i></button></a>      
        </nav>
    </div>
    <!-- Navbar End -->
    <!-- Footer Start -->
